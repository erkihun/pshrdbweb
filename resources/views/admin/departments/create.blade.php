...
@section('content')
    <div class="flex flex-col gap-6">
        <div>
            ...
            <p class="text-sm text-slate-500">{{ __('common.labels.departments') }}</p>
        </div>
        ...
        >
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('admin.departments.index') }}" class="text-sm font-semibold text-slate-500 hover:text-slate-700">
