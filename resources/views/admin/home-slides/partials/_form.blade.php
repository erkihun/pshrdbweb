...
<div class="space-y-8">
    ...
    <div>
        <div class="flex items-center justify-between mb-3">
            <label class="block text-sm font-semibold text-slate-900">
                Image
                @if($slide)
                    <span class="ml-1 text-slate-500">(optional)</span>
                @else
                    <span class="ml-1 text-rose-500">*</span>
                @endif
            </label>
            <span class="text-xs font-medium text-slate-500">
                {{ $slide ? 'Optional update' : 'Required' }}
            </span>
        </div>
        ...
        @if($slide)
            <div class="mt-6">
                <h4 class="mb-3 text-sm font-semibold text-slate-900">Current Image</h4>
        ...
        <div id="image-preview" class="mt-6 hidden">
            <h4 class="mb-3 text-sm font-semibold text-slate-900">New Image Preview</h4>
            <div class="overflow-hidden rounded-lg border border-slate-200 bg-slate-50">
    ...
    <div>
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-xs font-medium text-slate-500">Lower numbers appear first</span>
        </div>
        <input type="number"
               name="sort_order"
               ...
               placeholder="0">
        <p class="mt-2 text-xs text-slate-500">Set the display order (0 appears first, higher numbers appear later)</p>
    </div>
        ...
        <div class="flex items-start gap-3 rounded-lg border border-slate-200 bg-slate-50/50 p-4">
            ...
            <div class="flex-1">
                ...
                <p class="mt-1 text-sm text-slate-600">
                    When active, this slide will be visible on the homepage. Uncheck to temporarily hide it.
                </p>
