...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Homepage Slides</h1>
            <p class="mt-2 text-sm text-gray-600">
                Manage welcome page image slider
            </p>
        </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900 mb-2">No slides created yet</h3>
                                <p class="text-gray-500 mb-4">Get started by creating your first homepage slide</p>
                                <a href="{{ route('admin.home-slides.create') }}"
