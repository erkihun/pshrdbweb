    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h1 class="text-2xl font-semibold text-slate-900">Edit Vacancy Announcement</h1>
                <p class="text-sm text-slate-500">Update the date, title, and main content.</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.vacancies.update', $vacancy) }}" class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-6">
            ...
            <div class="flex items-center justify-between gap-3">
                ...
                <button type="submit" class="rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500">Update Announcement</button>
            </div>
        </form>
