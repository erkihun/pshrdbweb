...
<nav x-data="{ open: false, scrolled: false }"
    ...
    <div class="relative mx-auto max-w-full lg:max-w-screen-2xl w-full px-4 sm:px-6 lg:px-10">
        <div class="flex h-20 items-center justify-between">
            ...
            <div class="hidden lg:flex lg:items-center lg:gap-1 lg:ml-6 lg:mr-4 lg:flex-nowrap">
                ...
                @php
                    $desktopLinkBase = 'relative inline-flex items-center gap-2 rounded-xl px-3.5 py-2 text-sm font-medium transition-all duration-200';
                ...
                <div class="relative group">
                    <button type="button"
                            aria-haspopup="true"
                            class="{{ $desktopLinkBase }} {{ $desktopLinkHover }} {{ $aboutActive ? 'text-brand-blue' : 'text-gray-700' }}">
                ...
                <div class="relative group">
                    <button type="button"
                            aria-haspopup="true"
                            class="{{ $desktopLinkBase }} {{ $desktopLinkHover }} {{ $servicesActive ? 'text-brand-blue' : 'text-gray-700' }}">
                        <span class="inline-flex items-center gap-2">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex items-center gap-2 lg:ml-auto">
                ...
                {{-- MOBILE TOGGLE --}}
                <button type="button"
                        class="lg:hidden inline-flex items-center justify-center rounded-xl border border-gray-200 bg-white p-2.5 text-gray-700 shadow-sm hover:bg-gray-50 hover:text-orange-600 transition"
                        @click="open = !open"
                        :aria-expanded="open"
    ...
    <div x-show="open" x-transition x-cloak class="lg:hidden border-t border-gray-100 bg-white">
        <div class="px-4 py-4 space-y-2">
            ...
            @php
                $mobileLinkBase = 'block rounded-xl px-3 py-2.5 text-sm font-medium transition';
            ...
            {{-- Services (mobile) --}}
            <div class="rounded-2xl border border-gray-100 bg-gray-50/60 p-3">
